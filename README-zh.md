...
## 个人独立作品声明
本仓库由 **Pu Junhan** 独立开发完成。项目中涉及的第三方项目/规范仅用于互操作与兼容性验证；相关商标与外部资产归其各自权利人所有。

## 组织与政治立场分离声明
**本项目与任何境外公司或其母公司无隶属、无代言、无背书关系。** 作者明确与原 SPZ 项目所属组织的任何政治立场、言论或行动划清界限。本门卫独立运作，自行制定 SPZ 衍生合规标准。

**SPZ 衍生的合法性由本项目的开源协议确定，不由任何外部实体定义。** 用户与贡献者仅以是否遵守本项目界定的技术规范作为评判依据。

## 治理权声明
作为创建者与维护者，**Pu Junhan** 保留以下权利：
- 定义何为合规的 SPZ 衍生项目
- 拒绝为任何违反社区标准的项目背书
- 更新校验标准以维护 SPZ 生态的完整性与中立性
